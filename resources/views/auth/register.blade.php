...
<body style="background-image: url('{{ asset('uploads/lala.png') }}'); background-size: cover; background-repeat: no-repeat; background-position: center center;" class="bg-gray-500">
    <div class="flex justify-center items-center min-h-screen p-6">
        <div class="w-full max-w-md bg-white shadow-lg rounded-lg p-8" style="background-color: rgba(255, 255, 255, 0.85);">
